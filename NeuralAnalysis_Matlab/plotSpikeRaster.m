...
p.addParamValue('XLimForCell',[0 1],@(x) isnumeric(x) && isvector(x));
...
if islogical(spikes)
    ...
    xlim([0 1]);%[0+relSpikeStartTime nTimes+1+relSpikeStartTime]);
    ylim([0 nTrials+1]);        
    ...
    switch plotType
        ...
        case 'horzline2'
            ...
            plot(xPoints./24415, yPoints,'k', lineFormat{:});
